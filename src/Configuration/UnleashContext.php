...
final class UnleashContext implements Context
{
    ...
    public function setCustomProperty(string $name, string $value): \Rikudou\Unleash\Configuration\Context
    {
    ...
    public function removeCustomProperty(string $name, bool $silent = true): \Rikudou\Unleash\Configuration\Context
    {
    ...
    public function setCurrentUserId(?string $currentUserId): \Rikudou\Unleash\Configuration\Context
    {
        $this->currentUserId = $currentUserId;
    ...
    public function setIpAddress(?string $ipAddress): \Rikudou\Unleash\Configuration\Context
    {
        $this->ipAddress = $ipAddress;
    ...
    public function setSessionId(?string $sessionId): \Rikudou\Unleash\Configuration\Context
    {
        $this->sessionId = $sessionId;
